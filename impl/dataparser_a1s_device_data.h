...
#ifndef DATAPARSER_A1S_DEVICE_DATA_H
#define DATAPARSER_A1S_DEVICE_DATA_H
...
// 解析设备发送TCP数据
class DataParser_A1S_Device_Data
        : public IDataParser_Device
{
public:
    DataParser_A1S_Device_Data();
...
#endif // DATAPARSER_A1S_DEVICE_DATA_H

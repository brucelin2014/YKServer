...
#ifndef DATAPARSER_PS1_DEVICE_DATA_H
#define DATAPARSER_PS1_DEVICE_DATA_H
...
// 解析设备发送TCP数据
class DataParser_PS1_Device_Data
        : public IDataParser_Device
{
public:
    DataParser_PS1_Device_Data();
...
#endif // DATAPARSER_PS1_DEVICE_DATA_H

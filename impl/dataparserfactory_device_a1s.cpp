...
DataParserFactory_Device_A1S::DataParserFactory_Device_A1S()
{
...
// 5	指令回复
IDataParser_Device* DataParserFactory_Device_A1S::CreateDataParser(const int& dataType)
{
    switch (dataType)
    {
    case 1:
    ...
    case 2:
        return new DataParser_A1S_Device_Data();
    case 3:
        return nullptr;
    case 4:

...
DataParserFactory_Device_A3_2::DataParserFactory_Device_A3_2()
{
...
// 5	指令回复
IDataParser_Device* DataParserFactory_Device_A3_2::CreateDataParser(const int& dataType)
{
    switch (dataType)
    {
    case 1:
    ...
    case 2:
        return new DataParser_A3_2_Device_Data();
    case 3:
        return nullptr;
    case 4:

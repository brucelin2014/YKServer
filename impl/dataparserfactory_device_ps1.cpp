...
DataParserFactory_Device_PS1::DataParserFactory_Device_PS1()
{
...
// 5	指令回复
IDataParser_Device* DataParserFactory_Device_PS1::CreateDataParser(const int& dataType)
{
    switch (dataType)
    {
    case 1:
    ...
    case 2:
        return new DataParser_PS1_Device_Data();
    case 3:
        return nullptr;
    case 4:
